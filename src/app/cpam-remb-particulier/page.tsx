                ...
                <table className="table-auto w-full">
                  ...
                  <tbody className="text-sm divide-y divide-gray-100">
                    ...
                    <tr>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left">1 709 987 4343 1234 45</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium text-green-500">
                          31
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">74€</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">24/01/2024</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium ">11h35</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
...
export default CpamRembParticulier;
