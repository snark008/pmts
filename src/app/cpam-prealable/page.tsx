                ...
                <table className="table-auto w-full">
                  ...
                  <tbody className="text-sm divide-y divide-gray-100">
                    ...
                    <tr>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left">1 309 987 8763 0934 05</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium text-green-500">
                          21/11/2023
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <span className="rounded rounded-lg p-1 bg-amber-400 font-bold text-xs text-white">
                          En attente
                        </span>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left">1 198 182 5323 9034 02</div>
                      </td>
                      <td className="p-2 whitespace-nowrap">
                        <div className="text-left font-medium text-green-500">
                          04/12/2023
                      ...
                      <td className="p-2 whitespace-nowrap">
                        <span className="rounded rounded-lg p-1 bg-red-400 font-bold text-xs text-white">
                          Refusé
                        </span>
                      </td>
                    </tr>
